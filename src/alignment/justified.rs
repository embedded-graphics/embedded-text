...
impl<'a, C, F, V, H, HO> RendererFactory<'a, C> for StyledTextBox<'a, C, F, Justified, V, H, HO>
where
...
{
    type Renderer = StyledTextBoxIterator<'a, C, F, Justified, V, H, JustifiedSpaceConfig<F>, HO>;
