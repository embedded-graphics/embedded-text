...
use embedded_text::{
    prelude::*,
    style::{horizontal_overdraw::Wrap, vertical_overdraw::FullRowsOnly},
};
...
where
    ...
    for<'a> &'a StyledTextBox<'a, BinaryColor, Font6x8, LeftAligned, TopAligned, Exact<FullRowsOnly>, Wrap>:
